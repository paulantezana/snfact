    ...
    <div class="SnCard">
        <div class="SnCard-body">
            ...
            <div class="SnGrid m-2 SnMb-64">
                ...
                <form action="" class="SnForm" method="post">
                    ...
                    <div class="SnForm-item">
                        ...
                        <input type="email" class="SnForm-control" id="userEmail" name="userEmail" value="<?= $user['email'] ?>">
                    </div>
                    <div class="SnForm-item">
                        <label for="userUserName" class="SnForm-label">Nombre de usuario</label>
                        <input type="text" class="SnForm-control" id="userUserName" name="userUserName" value="<?= $user['user_name'] ?>">
                    </div>
                    <div class="SnForm-item">
            ...
            <div class="SnGrid m-2">
                ...
                <form action="" class="SnForm" method="post">
                    <input type="hidden" class="SnForm-control" name="userId">
                    <div class="SnForm-item">
                        <label for="userPassword" class="SnForm-label">Contrasena</label>
                        <input type="password" class="SnForm-control" name="userPassword" id="userPassword">
                    </div>
                    <div class="SnForm-item">
                        <label for="userConfirmPassword" class="SnForm-label">Confirmar contraseña</label>
                        <input type="password" class="SnForm-control" name="userConfirmPassword" id="userConfirmPassword">
                    </div>
                    <div class="SnForm-item">
