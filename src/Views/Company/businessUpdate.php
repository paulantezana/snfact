                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="SnGrid m-3">
                            <div class="SnForm-item required">
                                ...
                                <input type="text" class="SnForm-input" value="<?= $business['ruc'] ?>" name="business[ruc]" id="businessRuc" required>
                            </div>
                            <div class="SnForm-item required">
                                <label for="businessSocialReason" class="SnForm-label">Rasón social</label>
                                <input type="text" class="SnForm-input" value="<?= $business['social_reason'] ?>" name="business[social_reason]" id="businessSocialReason" required>
                            </div>
                            <div class="SnForm-item required">
                                <label for="businessCommercialReason" class="SnForm-label">Rasón comercial</label>
                                <input type="text" class="SnForm-input" value="<?= $business['commercial_reason'] ?>" name="business[commercial_reason]" id="businessCommercialReason" required>
                            </div>
                        </div>
                        <div class="SnGrid m-3">
                            <div class="SnForm-item required">
                                <label for="businessEmail" class="SnForm-label">Email</label>
                                <input type="text" class="SnForm-input" value="<?= $business['email'] ?>" name="business[email]" id="businessEmail" required>
                            </div>
                            <div class="SnForm-item required">
                                <label for="businessPhone" class="SnForm-label">Telefono</label>
                                <input type="text" class="SnForm-input" value="<?= $business['phone'] ?>" name="business[phone]" id="businessPhone" required>
                            </div>
                            <div class="SnForm-item required">
                                <label for="businessWebSite" class="SnForm-label">Sitio web</label>
                                <input type="text" class="SnForm-input" value="<?= $business['web_site'] ?>" name="business[web_site]" id="businessWebSite" required>
                            </div>
                        </div>
                        <img
                        ...
                        <div class="SnForm-item">
                            ...
                            <input type="file" class="SnForm-input" name="businessLogo" id="businessLogo"  accept="image/png,image/jpeg,image/jpg">
                        </div>
                        <div class="SnForm-item">
