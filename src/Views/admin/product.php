            ...
            <div class="SnModal-body">
                <form action="" class="SnForm" id="customerForm" onsubmit="CustomerForm.submit(event)">
                    ...
                    <div class="SnForm-item required">
                        <label for="customerFullName" class="SnForm-label">Nombre completo</label>
                        <input type="text" class="SnForm-input" id="customerFullName">
                    </div>
                    <div class="SnForm-item">
                        <label for="customerDocument" class="SnForm-label">N° de documento</label>
                        <input type="text" class="SnForm-input" id="customerDocument">
                    </div>
                    <div class="SnForm-item">
                        <label for="customerPhone" class="SnForm-label">Telefonoo</label>
                        <input type="text" class="SnForm-input" id="customerPhone">
                    </div>
                    <div class="SnForm-item">
                        <p>Estado</p>
